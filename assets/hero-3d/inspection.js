...
export function installInspection({T,hero,scene,world,camera,controls,units,renderer,render,query,floor}){
 ...
 panel.innerHTML='<label>Shot <select aria-label="Inspection shot"><option value="wide">Wide swarm</option><option value="low">Terrain low angle</option><option value="close">Aircraft close-up</option></select></label><label>Surface <select aria-label="Inspection surface"><option value="full">Full material</option><option value="gray">Gray clay</option><option value="normal">Geometry normals</option><option value="no-shadow">No shadows</option><option value="no-normal">No normal map</option></select></label>';
